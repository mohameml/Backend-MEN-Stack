...
exports.signup = exports.logout = exports.login = exports.forgetPassword = void 0;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Your count is created successfully!");
...
var forgetPassword = exports.forgetPassword = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          res = _context4.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "An Email is send in to your account for reset password");
          }
          _context4.next = 10;
          break;
        case 7:
  ...
  return function forgetPassword(_x7) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your data has been updated successfully!');
            window.setTimeout(function () {
              location.reload(true);
            }, 1000);
          }
...
var updateUserPassword = exports.updateUserPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(passwordCurr, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51QvIlTK79QlzAjfPUJvPxwTCB70m8PvDFV5u5Uc7xD9oepeSqvDIkt2uibBggtJvqi7K7c1UYqnWeuPx3ufwAm8400XBtQkZ7k'); // 1) Get the session from the server : 
...
var btnForgetPassword = document.querySelector('.btn-forget');
var btnBookingTour = document.getElementById('booking-tour');
...
if (updateUserDataForm) {
  updateUserDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateUser.updateUserData)(form);
  });
}
...
if (updateUserPasswordForm) {
  updateUserPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var passwordCurr, password, passwordConfirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            passwordCurr = document.getElementById('password-current').value;
            password = document.getElementById('password').value;
            passwordConfirm = document.getElementById('password-confirm').value;
            _context.next = 6;
            return (0, _updateUser.updateUserPassword)(passwordCurr, password, passwordConfirm);
          case 6:
          case "end":
            return _context.stop();
        }
...
if (btnForgetPassword) {
  btnForgetPassword.addEventListener('click', function (e) {
    var email = document.getElementById('email').value;
    if (!email) {
      (0, _alerts.showAlert)('error', 'Please Provide an email');
    } else {
...
// ================ Booking Tour ==================
if (btnBookingTour) {
  var tourId = btnBookingTour.dataset.tourid;
  btnBookingTour.addEventListener('click', function (e) {
    e.target.textContent = 'Processing ...';
    (0, _stripe.bookTour)(tourId);
    e.target.textContent = 'Book tour now!';
  });
}
},{"./alerts":"alerts.js","./auth":"auth.js","./mapbox":"mapbox.js","./updateUser":"updateUser.js","./stripe":"stripe.js"}]},{},["index.js"], null)
